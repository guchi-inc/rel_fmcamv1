...
const (
	// Label holds the string label denoting the govstreet type in the database.
	Label = "gov_street"
	...
	// Table holds the table name of the govstreet in the database.
	Table = "fm_gov_street"
)

// Columns holds all SQL columns for govstreet fields.
var Columns = []string{
	FieldID,
	FieldCode,
	FieldName,
...
// OrderOption defines the ordering options for the GovStreet queries.
