...
const (
	// Label holds the string label denoting the govcity type in the database.
	Label = "gov_city"
	...
	// Table holds the table name of the govcity in the database.
	Table = "fm_gov_city"
)

// Columns holds all SQL columns for govcity fields.
var Columns = []string{
	FieldID,
	FieldCode,
	FieldName,
...
// OrderOption defines the ordering options for the GovCity queries.
