...
func (pq *ProvinceQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *ProvinceQuery) FirstIDX(ctx context.Context) int64 {
...
func (pq *ProvinceQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *ProvinceQuery) OnlyIDX(ctx context.Context) int64 {
...
func (pq *ProvinceQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (pq *ProvinceQuery) IDsX(ctx context.Context) []int64 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *ProvinceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(province.Table, province.Columns, sqlgraph.NewFieldSpec(province.FieldID, field.TypeInt64))
	_spec.From = pq.sql
