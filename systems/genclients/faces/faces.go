...
const (
	// Label holds the string label denoting the faces type in the database.
	Label = "faces"
	...
	// Table holds the table name of the faces in the database.
	Table = "Face"
)

// Columns holds all SQL columns for faces fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldProfileID,
...
// OrderOption defines the ordering options for the Faces queries.
